;(function () {
    ...
    var isClicking = false; // Flag to manage state

    // New function to handle animations on click
    ...
    // Check for visible sections on page load and animate them
    ...
    $(function(){
        ...
        checkOnLoad(); // Call the new function to fix the refresh issue
    });
